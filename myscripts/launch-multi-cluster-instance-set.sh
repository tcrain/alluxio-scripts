...
./launch-instances.sh "$masterCount" c5.2xlarge master,worker 1 c1
./launch-instances.sh "$masterCount" c5.2xlarge master,worker 1 c2
./launch-instances.sh "$masterCount" c5.2xlarge master,worker 1 c3

./launch-instances.sh "$otherCount" c5.2xlarge other 1 c1