...
~/alluxio/bin/alluxio runClass alluxio.stress.cli.StressMasterBench --operation CreateDir --warmup 5s --duration 10s --target-throughput 1000000 --fixed-count 10
...
~/alluxio/bin/alluxio runClass alluxio.stress.cli.StressMasterBench --operation GetFileStatus --warmup 5s --duration 10s --target-throughput 1000000 --fixed-count 10
